...
public class ListarMejoras implements Serializable {
    ...
    //  Getters
    public List<Mejora> getListaAcciones() {
    ...
    public EnumEstado[] getEstadosSeleccionados() {
    ...
    //  Setters
    public void setListaAcciones(List<Mejora> ListaAcciones) {
    ...
    public void setEstadosSeleccionados(EnumEstado[] estadosSeleccionados) {
    ...
    // Metodos
    //<editor-fold desc="Metodos de filtro de Fechas">
    /**
     ...
     * @return
     */
    private List<Accion> filtrarPorFechas(List<Mejora> accionesAFiltrar) {
    ...
    //</editor-fold>
    //<editor-fold desc="Metodos de filtro de Areas">
    /**
     * Llena la lista de acciones con las que contengan las areas seleccionadas.
     *
     * @param accionesAFiltrar
     * @return
     */
    private List<Accion> filtrarPorArea(List<Mejora> accionesAFiltrar) {
    ...
    //</editor-fold>
    //<editor-fold desc="Metodos de filtro de Deteccion">
     ...
     * @return
     */
    private List<Accion> filtrarPorDeteccion(List<Mejora> accionesAFiltrar) {
    ...
    //</editor-fold>
    //<editor-fold desc="Metodos de filtro de Codificacion">
    /**
     ...
     * @return
     */
    private List<Accion> filtrarPorCodificacion(List<Mejora> accionesAFiltrar) {
    ...
    //</editor-fold>
    //<editor-fold desc="Metodos de filtro de Estado">
     ...
     * @return
     */
    private List<Accion> filtrarPorEstado(List<Mejora> accionesAFiltrar) {
    ...
    public void filtrarPorEstado(AjaxBehaviorEvent event) {
        if (!ListaCompletaAcciones.isEmpty() && !filtrosAplicados.contains("estados")) {
    ...
    private void FiltrarAcciones() {
        List<Mejora> accionesFiltradas = ListaCompletaAcciones;
            ...
            for (int i = 0; i < filtrosAplicados.size(); i++) {
                ...
                switch (filtro) {
                    case "fechas":
                        ...
                        accionesFiltradas = (List<Mejora>) (List<?>) filtrarPorFechas(accionesFiltradas);
                    ...
                    case "areas":
                        accionesFiltradas = (List<Mejora>) (List<?>) filtrarPorArea(accionesFiltradas);
                    ...
                    case "detecciones":
                        accionesFiltradas = (List<Mejora>) (List<?>) filtrarPorDeteccion(accionesFiltradas);
                    ...
                    case "codificaciones":
                        ...
                        accionesFiltradas = (List<Mejora>) (List<?>) filtrarPorCodificacion(accionesFiltradas);
                    ...
                    case "estados":
                        accionesFiltradas = (List<Mejora>) (List<?>) filtrarPorEstado(accionesFiltradas);
