...
@Named
@ViewScoped
public class SeguimientoMejora implements Serializable {
    @Inject
    ...
    public void setFechaImplementacionActividad(int IdActividad){
        if((fDatos.SetFechaImplementacionActividadMejora(FechaImplementacion, IdActividad))== -1){
    ...
    public void init(){
        ...
        if(IdAccion != 0){
            Accion AccionSeguimiento = (Mejora) fLectura.GetAccion(IdAccion);
